CREATE TABLE USERS(id SERIAL,
  ...
  role VARCHAR(30), PRIMARY KEY (id));

CREATE TABLE USER_PROFILE(id SERIAL,
  ...
  country VARCHAR(30), PRIMARY KEY (id),FOREIGN KEY (user_id) REFERENCES USERS(id) ON DELETE CASCADE);
