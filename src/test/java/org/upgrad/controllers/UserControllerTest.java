...
public class UserControllerTest {
    ...
    public void registerUserWithExistingEmail() throws Exception{
        ...
        user.setId(1);
        user.setUserName("upgrad");
        user.setEmail("upgrad@upgrad.com");
        String firstName = "software";
        String lastName= "development";
        String userName = "upgrad";
        String email = "upgrad@upgrad.com";
    ...
    public void loginAsAdmin() throws Exception{
        ...
        Mockito.when(userService.getPasswordByUsername(userName)).thenReturn(passwordHash);
        Mockito.when(userService.getRoleByUsername(userName)).thenReturn(role);
